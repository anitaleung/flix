...
- [x] Added a “No results found” label when no movies are found
...
Would be interested in adding a bookmark feature and integrating more details about the movies for future versions.
